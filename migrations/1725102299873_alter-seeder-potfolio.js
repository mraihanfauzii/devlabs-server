...
exports.up = (pgm) => {
    ...
    ('8049d2c6-9df0-4d3d-9d18-ddc63beb408e', 'cb9461f3-bf21-44c7-bc92-e9f0db109920', 'Modern Cozy Home', 'A modern cozy home design with a warm and inviting atmosphere.', (SELECT id FROM themes WHERE name = 'Modern'), 1700000),
    ...
    ('8049d2c6-9df0-4d3d-9d18-ddc63beb408e', '6d9f5d47-4ed5-4d39-b65a-c9e6ecb9ff5e', 'Traditional Farmhouse Home', 'A modern traditional farmhouse home design with rustic elements and modern amenities.', (SELECT id FROM themes WHERE name = 'Traditional'), 2700000),
